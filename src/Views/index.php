...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="public/assets/compiled/png/logo.png" width="136" height="46" alt="Doclab home">
      </a>
      ...
      <a href="/login" class="btn has-before title-md">Log in Sebagai Petugas</a>
      ...
      <section class="section hero" style="background-image: url('./assets/images/hero-bg.png')" aria-label="home">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle has-before" data-reveal="left">Welcome To APIK</p>
            ...
            <div class="hero-card" data-reveal="left">
              ...
              <p class="title-lg card-text">
                Solusi digital inovatif dengan fitur penebusan obat yang lebih mudah, cepat, dan aman.
              </p>
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card" data-reveal="bottom">
                ...
                <h3 class="headline-sm card-title">
                  <a href="#">Kemudahan akses dan penggunaan</a>
                </h3>
              </div>
            </li>
            ...
            <li>
              <div class="service-card" data-reveal="bottom">
                ...
                <h3 class="headline-sm card-title">
                  <a href="#">Efisiensi dalam proses Penebusan Resep</a>
                </h3>
              </div>
            </li>
            ...
            <li>
              <div class="service-card" data-reveal="bottom">
                ...
                <h3 class="headline-sm card-title">
                  <a href="#">Manajemen data yang terorganisir</a>
                </h3>
            ...
            <li>
              <div class="service-card" data-reveal="bottom">
                ...
                <h3 class="headline-sm card-title">
                  <a href="#">Riwayat pembayaran yang terintegrasi</a>
                </h3>
              </div>
            </li>
        ...
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="tab-text" data-reveal="left">
              Kami berkomitmen untuk memberikan perawatan kesehatan berkualitas tinggi yang berfokus pada kebutuhan individu pasien, serta memajukan 
              kesejahteraan masyarakat dengan standar tertinggi dalam praktik medis dan layanan kesehatan.
            </p>
            ...
            <div class="wrapper">
              ...
              <ul class="about-list">
                ...
                <li class="about-item" data-reveal="left">
                  ...
                  <span class="span">Keahlian luas dalam diagnosis dan perawatan</span>
                </li>

                <li class="about-item" data-reveal="left">
                  <ion-icon name="checkmark-circle-outline"></ion-icon>

                  <span class="span">Memiliki sertifikasi dari berbagai lembaga medis terkemuka</span>
                </li>

                <li class="about-item" data-reveal="left">
                  <ion-icon name="checkmark-circle-outline"></ion-icon>

                  <span class="span">Pendekatan yang ramah dan profesional</span>
                </li>

                <li class="about-item" data-reveal="left">
                  <ion-icon name="checkmark-circle-outline"></ion-icon>

                  <span class="span">Aktif mengikuti perkembangan terbaru di dunia kedokteran</span>
                </li>
        ...
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li>
              ...
              <h2 class="headline-md" data-reveal="left">Poliklinik</h2>
            </li>
    ...
    <div class="container">
      ...
      <div class="section footer-top">
        ...
        <div class="footer-brand" data-reveal="bottom">
          ...
          <a href="#" class="logo">
            <img src="public/assets/compiled/png/logo.png" width="136" height="46" loading="lazy" alt="Doclab home">
          </a>
