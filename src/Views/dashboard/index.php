...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        profileDropdown.addEventListener("click", function (event) {
            event.preventDefault(); // Mencegah navigasi ke tautan '#' yang tidak diperlukan
            dropdownMenu.classList.toggle("show"); // Tambah atau hapus kelas 'show' pada dropdown menu
        });

        // Menutup dropdown ketika klik dilakukan di luar dropdown
